...
@interface DictionaryViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate, UISearchDisplayDelegate,UIScrollViewDelegate>
{
...
- (void)loadSearchBar
{
    theSearchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 64, self.view.bounds.size.width, 540)];
...
- (void)creatTableView {
    _tableV = [[UITableView alloc] initWithFrame:CGRectMake(0, 108, self.view.bounds.size.width, 540)];
